...
$result = $wssm->getUsersPackage($userId, $errorstring, $nodes);

/* Check the result for error */
if ($result !== true) {
	return $modx->error->failure($modx->lexicon('getuserspackagefailed')." - ".$errorstring);
}
