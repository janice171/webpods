 ...
 * @package ws_userextensions
 */
require_once (strtr(realpath(dirname(dirname(__FILE__))), '\\', '/') . '/weddingusergalleryalbum.class.php');
class weddingUserGalleryAlbum_mysql extends weddingUserGalleryAlbum {}
?>