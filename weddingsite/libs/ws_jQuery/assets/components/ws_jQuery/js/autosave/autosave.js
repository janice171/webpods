...
;(function($) {
	$.fn.autosave = function(options) {
		...
		function setEvents ()
		{
			...
			ev = true;
            WS.autosaveRestore = $.fn.autosave.restore;
            WS.autosaveRemoveCookies = $.fn.autosave.removeAllCookies;
		}
	...
	$.fn.autosave.restore = function () {
		...
		if (cookiecheck !== null)
		{
			...
			for (i in m.check)
			{
				var chek = (cookiecheck[i] == $.fn.autosave.options.cookieCheckboxValue) ? 'checked' : '';
