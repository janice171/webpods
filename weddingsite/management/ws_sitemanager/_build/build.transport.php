...
$builder->registerNamespace('ws_sitemanager', false, true, '{core_path}components/ws_sitemanager/');
$base = dirname(dirname(__FILE__)) . '/';
$sources= array (
    'root' => $base,
    'assets' => $base . 'assets/components/ws_sitemanager/',
    'docs' => $base . 'assets/components/ws_sitemanager/docs/',
    'core' => $base . 'core/components/ws_sitemanager/',
    'lexicon' => $base . 'core/components/ws_sitemanager/lexicon/',
    'model' => $base . 'core/components/ws_sitemanager/model/',
    'templates' => $base . 'core/components/ws_sitemanager/templates/',
    'build' => $base . '_build/',
    'data' => $base . '_build/data/',
    'resolvers' => $base . '_build/resolvers/',
    'source_core' => $base . 'core/components/ws_sitemanager',
    'source_assets' => $base . 'assets/components/ws_sitemanager',
);
unset($base);
