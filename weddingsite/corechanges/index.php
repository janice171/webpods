...
/* Context to host mapping array, add to this as needed */
$contextMap = array (
    'wedding' => 'www.theweddingwebsitegroup.com'
    );

/* Initialize the context from the context map */
$context="web"; // Default context
foreach ( $contextMap as $contextKey => $host ) {
    
    $incomingHost = strtolower(MODX_HTTP_HOST);
    $hostPort = $host . ":80";
    if ( ($incomingHost = $host) || ($incomingHost = $hostPort)) {
