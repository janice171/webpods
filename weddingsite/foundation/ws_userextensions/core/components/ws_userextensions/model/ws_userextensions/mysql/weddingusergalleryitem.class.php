 ...
 * @package ws_userextensions
 */
require_once (strtr(realpath(dirname(dirname(__FILE__))), '\\', '/') . '/weddingusergalleryitem.class.php');
class weddingUserGalleryItem_mysql extends weddingUserGalleryItem {}
?>