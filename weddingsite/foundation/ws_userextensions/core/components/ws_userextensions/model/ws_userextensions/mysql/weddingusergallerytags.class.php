 ...
 * @package ws_userextensions
 */
require_once (strtr(realpath(dirname(dirname(__FILE__))), '\\', '/') . '/weddingusergallerytags.class.php');
class weddingUserGalleryTags_mysql extends weddingUserGalleryTags {}
?>