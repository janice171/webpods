...
// ================================================	
	...
	function iBrowser_open() {	
		...
		if (ib.isMSIE) { // IE
			var rArgs = showModalDialog(ib.baseURL+ '?website='+WS.website, wArgs, 'dialogHeight:500px; dialogWidth:580px; scrollbars: no; menubar: no; toolbar: no; resizable: no; status: no;');  
			...
			var wnd = window.open(ib.baseURL + '?website='+WS.website+'&editor=' + ib.editor + '&callback=iBrowser_callback', '_blank', 'status=0, location=0, scrollbars=0, width=650, height=500');
