<?php
/**
 * Wedding site Paypal IPN Library (ws_paypal)
 *
...
/* define package */
define('PKG_NAME','WS_Paypal');
define('PKG_NAME_LOWER','ws_paypal');
...
$modx->lexicon->load('ws_paypal:properties');
